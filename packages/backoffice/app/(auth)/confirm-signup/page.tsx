...
export default async function BackofficeConfirmSignupPage({
	searchParams,
}: {
	...
	return (
		<main className='mx-auto max-w-md space-y-6 p-6'>
			<h1>Confirm Backoffice Account</h1>
			{hasError ? (
			...
			<form action='/api/auth/confirm-signup' method='post' className='space-y-4'>
				<p>
			...
			<form action='/api/auth/resend-confirmation' method='post' className='space-y-2'>
